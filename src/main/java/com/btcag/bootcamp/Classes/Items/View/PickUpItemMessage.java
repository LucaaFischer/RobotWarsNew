...
public class PickUpItemMessage {
    public static void PickUpMessage(String itemName, int value, Robot robotTurn, Robot robotNotTurn, Player playerTurn, Player playerNotTurn) {
    ...
    public static void alreadyHaveThisItemMessage() {
